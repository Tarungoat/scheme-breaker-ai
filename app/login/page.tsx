    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-6 bg-[#0a0a0a] text-white font-sans selection:bg-[#00b4d8] selection:text-[#0a0a0a]">
      <div className="w-full max-w-md p-10 space-y-8 bg-[#111] border-2 border-white/10 rounded-none shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        <div className="text-center">
          <h1 className="text-4xl font-black tracking-tighter uppercase text-white">Log In</h1>
          <p className="mt-4 text-xs font-bold tracking-widest text-white/40 uppercase">Aced it. Back for more?</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="mt-10 space-y-8">
          ...
          >
            {loading ? 'Authorizing...' : 'Log into Analytics'}
          </button>
        </form>

        <p className="text-center text-[10px] font-black tracking-widest text-white/30 uppercase pt-4 border-t border-white/5">
          New to the lab?{' '}
          <Link href="/signup" className="text-[#00b4d8] hover:text-white transition-colors duration-200">
            Create account
          </Link>
        </p>
      </div>
